...
export default function BuyerRegisterPage() {
  ...
  return (
    <div className="h-svh flex flex-col md:flex-row">
      ...
      <div
        ref={leftRef}
        className="md:w-1/2 relative bg-cover bg-center text-white flex items-center justify-center p-10"
        style={{ backgroundImage: `url('/buyer-register-bg.jpg')` }}
      >
      ...
      >
        <div className="w-full max-w-md">
         <h3 className="text-2xl font-bold bg-gradient-to-r from-green-600 to-blue-500 bg-clip-text text-transparent mb-6 text-center">
  Create Buyer Account
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              <input type="text" placeholder="GSTIN (optional)" {...register('gstin')} className="input-field" />
            </div>
